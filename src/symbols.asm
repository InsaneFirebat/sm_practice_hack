...
ram_tel_debug_area = !ram_tel_debug_area ; !WRAM_START+$44
ram_tel_debug_station = !ram_tel_debug_station ; !WRAM_START+$46
...
ram_slowdown_mode = !ram_slowdown_mode ; $7EFFFE
...
ram_cm_metroid = !ram_cm_metroid ; !WRAM_MENU_START+$9C
ram_cm_gravboots = !ram_cm_gravboots ; !WRAM_MENU_START+$9E
ram_cm_darkvisor = !ram_cm_darkvisor ; !WRAM_MENU_START+$A0
ram_cm_hyper = !ram_cm_hyper ; !WRAM_MENU_START+$A2
