...
NumberGFXTable:
    ...
    dw #$0C70, #$0C71, #$0C72, #$0C73, #$0C74, #$0C75, #$0C7C, #$0C7D, #$0C7E, #$0C7F
    dw #$0CD0, #$0CD1, #$0CD2, #$0CD3, #$0CD4, #$0CD5, #$0CD6, #$0CD7, #$0C0B, #$0C0C
    dw #$0C0D, #$0C8D, #$0CCA, #$0C5D, #$0C5D, #$0CB0, #$0CB1, #$0CB2, #$0CB3, #$0CB4
    dw #$0CB5, #$0CB6, #$0CB7, #$0CB8, #$0CB9, #$0CBA, #$0CBB, #$0CBC, #$0CBD, #$0CBE
    dw #$0CBF, #$0CC0, #$0CC1, #$0CC2, #$0CC3, #$0CC4, #$0CC5, #$0CC6, #$0CC7, #$0CDA
    dw #$0CDB, #$0CDC, #$0CDD, #$0CDE, #$0CDF, #$0C31
