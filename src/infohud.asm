...
NumberGFXTable:
    ...
    dw #$0C55, #$0C56, #$0C57, #$0CD2, #$0C4E, #$0C10, #$0C11, #$0C12, #$0C13, #$0C14
    dw #$0C15, #$0C16, #$0C17, #$0C18, #$0C19, #$0C1A, #$0C1B, #$0C1C, #$0C1D, #$0C1E
    dw #$0C11, #$0C20, #$0C21, #$0C22, #$0C23, #$0C24, #$0C25, #$0C26, #$0C27, #$0C28
    dw #$0C29, #$0C2A, #$0C2B, #$0C2C, #$0C2D, #$0C2E, #$0C2F, #$0C4D, #$0C4F, #$0C5E
    dw #$0C5F, #$0C6D, #$0C6E, #$0C6F, #$0C76, #$0C77, #$0C8E, #$0C42, #$0C43, #$0C44 ; up to 56, then inverted single digits :(
    dw #$0C45, #$0C3C, #$0C3D, #$0C3E, #$0C3F, #$0CCE ; 65 included

HexGFXTable:
    dw #$0C09, #$0C00, #$0C01, #$0C02, #$0C03, #$0C04, #$0C05, #$0C06, #$0C07, #$0C08
    dw #$0CD8, #$0CD9, #$0C0D, #$0C30, #$0C31, #$0C32
...
ControllerGfx1:
      ;  L       ^       R       Y       X       Sl
    dw #$0CB8, #$0CD6, #$0CCA, #$0CDB, #$0CDA, #$0C47
ControllerGfx2:
      ;  <       v       >       B       A       St
    dw #$0CD4, #$0CD7, #$0CD6, #$0CD9, #$0CD8, #$0C48
