...
NumberGFXTable:
    ...
    dw #$0C0B, #$0C0C, #$0C0D, #$0C47, #$0C48, #$0CBA, #$0C80, #$0C81, #$0C82, #$0C83
    dw #$0C84, #$0C85, #$0C86, #$0C87, #$0C88, #$0C89, #$0C8A, #$0C8B, #$0C8C, #$0C8D
    dw #$0C8E, #$0C8F, #$0C90, #$0C91, #$0C92, #$0C93, #$0C94, #$0C95, #$0C96, #$0C97
    dw #$0C98, #$0C99, #$0C9A, #$0C9B, #$0C9C, #$0C9D, #$0C9E, #$0C9F, #$0CA0, #$0CA1
    dw #$0CA2, #$0CA3, #$0CA4, #$0CA5, #$0CA6, #$0CA7, #$0CA8, #$0CA9, #$0CAA, #$0CAB
    dw #$0CAC, #$0CAD, #$0CAE, #$0CAF, #$0CB0, #$0CB1
...
ControllerGfx1:
      ;  L       ^       R       Y       X       Sl
    dw #$0C30, #$0CB7, #$0C31, #$0CDF, #$0CDD, #$0C32
ControllerGfx2:
      ;  <       v       >       B       A       St
    dw #$0CB6, #$0CB9, #$0CB8, #$0CDC, #$0CDB, #$0C33
