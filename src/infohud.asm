...
NumberGFXTable:
    ...
    dw #$0C81, #$0C82, #$0C83, #$0C84, #$0C85, #$0C86, #$0C87, #$0C90, #$0C91, #$0C92
    dw #$0C93, #$0C94, #$0C95, #$0C96, #$0C97, #$0C98, #$0C99, #$0C9A, #$0C9B, #$0C9C
    dw #$0C9D, #$0C9E, #$0C9F, #$0CBA, #$0CBB, #$0CDB, #$0CDC, #$0C12, #$0C13, #$0C14
    dw #$0C15, #$0C16, #$0C17, #$0C18, #$0C19, #$0C1A, #$0C5D, #$0C20, #$0C21, #$0C22
    dw #$0C23, #$0C24, #$0C25, #$0C26, #$0C27, #$0C28, #$0C29, #$0C2A, #$0C2B, #$0C2C
    dw #$0C2D, #$0C2E, #$0C2F, #$0C3C, #$0C3D, #$0CDD

HexGFXTable:
    dw #$0C00, #$0C01, #$0C02, #$0C03, #$0C04, #$0C05, #$0C06, #$0C07, #$0C08, #$0C09
    dw #$0CA4, #$0CA5, #$0CAC, #$0CAD, #$0CAE, #$0CAF
...
ControllerGfx1:
      ;  L       ^       R       Y       X       Sl
    dw #$0CA8, #$0CA1, #$0CA9, #$0CA7, #$0CA6, #$0CAA
ControllerGfx2:
      ;  <       v       >       B       A       St
    dw #$0CA0, #$0CA3, #$0CA2, #$0CA5, #$0CA4, #$0CAB
