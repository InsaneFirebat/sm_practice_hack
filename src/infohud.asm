...
NumberGFXTable:
    ...
    dw #$0C09, #$0C00, #$0C01, #$0C02, #$0C03, #$0C04, #$0C05, #$0C06, #$0C07, #$0C08 ; 0x
;    dw #$0C61, #$0C62, #$0C63, #$0C64, #$0C65, #$0C66, #$0C67, #$0C68, #$0C69, #$0C6A
    dw #$0C70, #$0C71, #$0C72, #$0C73, #$0C74, #$0C75, #$0C78, #$0C79, #$0C7A, #$0C7B ; 1x
    dw #$0C7C, #$0C7D, #$0C7E, #$0C7F, #$0C8F, #$0C4D, #$0C4F, #$0C5E, #$0C5F, #$0C6D ; 2x
    dw #$0C6E, #$0C6F, #$0C8E, #$0C5C, #$0C5D, #$0CB8, #$0C8D, #$0C12, #$0C13, #$0C14 ; 3x
    dw #$0C15, #$0C16, #$0C17, #$0C18, #$0C19, #$0C1A, #$0C1B, #$0C20, #$0C21, #$0C22 ; 4x
    dw #$0C23, #$0C24, #$0C25, #$0C26, #$0C27, #$0C28, #$0C29, #$0C2A, #$0C2B, #$0C2C ; 5x
    dw #$0C2D, #$0C2E, #$0C2F, #$0C30, #$0C31, #$0CD2                                 ; 6x

HexGFXTable:
    dw #$0C09, #$0C00, #$0C01, #$0C02, #$0C03, #$0C04, #$0C05, #$0C06, #$0C07, #$0C08
    dw #$0CE0, #$0CE1, #$0CE2, #$0CE3, #$0CE4, #$0CE5
