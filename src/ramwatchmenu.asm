...
ih_prepare_ram_watch_menu:
{
    ...
    LDA !ram_watch_left : CMP #!ENEMY_ID : BCC .checkright : CMP #$1778 : BCS .checkright
    BRA .found_enemy_ram

  .checkright
    LDA !ram_watch_right : CMP #!ENEMY_ID : BCC .submenu : CMP #$1778 : BCS .submenu
...
ramwatch_common_misc_05E5:
    %cm_jsl("RNG Seed Value", action_select_common_address, #!RANDOM_NUMBER)
