PresetsMenuKpdr22:
    ...
    dw #presets_goto_kpdr22_red_brinstar_final
...
presets_goto_kpdr22_red_brinstar_final:
    %cm_submenu("Red Brinstar Final", #presets_submenu_kpdr22_red_brinstar_final)
...
presets_submenu_kpdr22_brinstar:
    ...
    dw #presets_kpdr22_brinstar_entering_kraids_lair
    dw #presets_kpdr22_brinstar_kraid_kihunters
    dw #presets_kpdr22_brinstar_mini_kraid
    dw #presets_kpdr22_brinstar_kraid
    dw #presets_kpdr22_brinstar_leaving_varia
    dw #presets_kpdr22_brinstar_mini_kraid_revisit
    dw #presets_kpdr22_brinstar_kraid_kihunters_revisit
    dw #presets_kpdr22_brinstar_kraid_etank
    dw #$0000
    %cm_header("BRINSTAR")

presets_submenu_kpdr22_upper_norfair:
    dw #presets_kpdr22_upper_norfair_business_center
    dw #presets_kpdr22_upper_norfair_hi_jump_etank
    dw #presets_kpdr22_upper_norfair_leaving_hi_jump
    dw #presets_kpdr22_upper_norfair_business_center_2
    ...
    dw #presets_kpdr22_upper_norfair_business_center_3
    dw #$0000
...
presets_submenu_kpdr22_red_brinstar_final:
    dw #presets_kpdr22_red_brinstar_final_red_tower_elevator
    dw #presets_kpdr22_red_brinstar_final_hellway_revisit
    dw #presets_kpdr22_red_brinstar_final_red_tower_down
    dw #presets_kpdr22_red_brinstar_final_skree_boost_final
    dw #presets_kpdr22_red_brinstar_final_below_spazer_final
    dw #$0000
    %cm_header("RED BRINSTAR FINAL")

presets_submenu_kpdr22_maridia:
    dw #presets_kpdr22_maridia_breaking_tube
    ...
    dw #presets_kpdr22_maridia_womple_jump
...
presets_submenu_kpdr22_backtracking:
    ...
    dw #presets_kpdr22_backtracking_mt_everest_revisit_revisit
...
presets_kpdr22_brinstar_entering_kraids_lair:
    %cm_preset("Entering Kraid's Lair", #preset_kpdr22_brinstar_entering_kraids_lair)

presets_kpdr22_brinstar_kraid_kihunters:
    %cm_preset("Kraid Kihunters", #preset_kpdr22_brinstar_kraid_kihunters)

presets_kpdr22_brinstar_mini_kraid:
    %cm_preset("Mini Kraid", #preset_kpdr22_brinstar_mini_kraid)

presets_kpdr22_brinstar_kraid:
    %cm_preset("Kraid", #preset_kpdr22_brinstar_kraid)

presets_kpdr22_brinstar_leaving_varia:
    %cm_preset("Leaving Varia", #preset_kpdr22_brinstar_leaving_varia)

presets_kpdr22_brinstar_mini_kraid_revisit:
    %cm_preset("Mini Kraid Revisit", #preset_kpdr22_brinstar_mini_kraid_revisit)

presets_kpdr22_brinstar_kraid_kihunters_revisit:
    %cm_preset("Kraid Kihunters Revisit", #preset_kpdr22_brinstar_kraid_kihunters_revisit)

presets_kpdr22_brinstar_kraid_etank:
    %cm_preset("Kraid E-tank", #preset_kpdr22_brinstar_kraid_etank)


; Upper Norfair
presets_kpdr22_upper_norfair_business_center:
    %cm_preset("Business Center", #preset_kpdr22_upper_norfair_business_center)
...
presets_kpdr22_upper_norfair_business_center_2:
    %cm_preset("Business Center 2", #preset_kpdr22_upper_norfair_business_center_2)
...
presets_kpdr22_upper_norfair_business_center_3:
    %cm_preset("Business Center 3", #preset_kpdr22_upper_norfair_business_center_3)
...
; Red Brinstar Final
presets_kpdr22_red_brinstar_final_red_tower_elevator:
    %cm_preset("Red Tower Elevator", #preset_kpdr22_red_brinstar_final_red_tower_elevator)

presets_kpdr22_red_brinstar_final_hellway_revisit:
    %cm_preset("Hellway Revisit", #preset_kpdr22_red_brinstar_final_hellway_revisit)

presets_kpdr22_red_brinstar_final_red_tower_down:
    %cm_preset("Red Tower Down", #preset_kpdr22_red_brinstar_final_red_tower_down)

presets_kpdr22_red_brinstar_final_skree_boost_final:
    %cm_preset("Skree Boost Final", #preset_kpdr22_red_brinstar_final_skree_boost_final)

presets_kpdr22_red_brinstar_final_below_spazer_final:
    %cm_preset("Below Spazer Final", #preset_kpdr22_red_brinstar_final_below_spazer_final)


; Maridia
presets_kpdr22_maridia_breaking_tube:
    %cm_preset("Breaking Tube", #preset_kpdr22_maridia_breaking_tube)
...
presets_kpdr22_maridia_womple_jump:
    %cm_preset("Womple Jump", #preset_kpdr22_maridia_womple_jump)
...
presets_kpdr22_backtracking_mt_everest_revisit_revisit:
    %cm_preset("Mt Everest Revisit Revisit", #preset_kpdr22_backtracking_mt_everest_revisit_revisit)
