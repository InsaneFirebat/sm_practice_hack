...
preset_prkd15_brinstar_early_supers:
    ...
    dw $0919, $0315 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $0000 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $00E0 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $09C6, $0000 ; Missiles
    dw $0A1C, $0001 ; Samus position/state
...
preset_prkd15_brinstar_dachora_room:
    ...
    dw $0919, $0493 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $FF00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
...
preset_prkd15_brinstar_noob_bridge:
    ...
    dw $0917, $04E8 ; Layer 2 X scroll in room in pixels?
...
preset_prkd15_brinstar_hellway:
    ...
    dw $0917, $0000 ; Layer 2 X scroll in room in pixels?
    dw $0919, $0004 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0923, $FC00 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
...
preset_prkd15_brinstar_alpha_power_bombs:
    ...
    dw $0917, $0000 ; Layer 2 X scroll in room in pixels?
    dw $0919, $0717 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0923, $FB00 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $09CA, $0003 ; Supers
    dw $0A1C, $0002 ; Samus position/state
    dw $0A1E, $0004 ; More position/state
...
preset_prkd15_brinstar_horizontal_bomb_jump:
    ...
    dw $0913, $0000 ; Screen subpixel Y position
    dw $0917, $0063 ; Layer 2 X scroll in room in pixels?
    dw $0921, $0100 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $0000 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    ...
    dw $D870, $0190 ; Events, Items, Doors
...
preset_prkd15_wrecked_ship_reverse_moat:
    ...
    dw $0AFA, $049B ; Samus Y
    dw $D91A, $0023 ; Events, Items, Doors
    dw #$FFFF
.after
...
preset_prkd15_wrecked_ship_crateria_kihunters_return:
    ...
    dw $0919, $0003 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $FE00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $0000 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
...
preset_prkd15_red_brinstar_revisit_leaving_spazer:
    ...
    dw $0A1E, $0004 ; More position/state
    dw $0AF6, $0053 ; Samus X
    dw $D874, $0504 ; Events, Items, Doors
    dw $D8B6, $B008 ; Events, Items, Doors
...
preset_prkd15_red_brinstar_revisit_business_center_preelev:
    ...
    dw $0915, $0000 ; Screen Y position in pixels
    dw $09CE, $0002 ; Pbs
    dw $09D2, $0000 ; Current selected weapon
...
preset_prkd15_upper_norfair_hi_jump_etank:
    ...
    dw $0AF6, $0049 ; Samus X
    dw $0AFA, $058B ; Samus Y
    dw $D8B8, $2000 ; Events, Items, Doors
    dw #$FFFF
.after
...
preset_prkd15_upper_norfair_ice_beam_gates:
    ...
    dw $0917, $0000 ; Layer 2 X scroll in room in pixels?
    dw $0919, $0249 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0923, $FB00 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    ...
    dw $D8B8, $2800 ; Events, Items, Doors
    dw #$FFFF
.after
...
preset_prkd15_upper_norfair_ice_maze_down:
    ...
    dw $D876, $0124 ; Events, Items, Doors
...
preset_prkd15_upper_norfair_cathedral:
    ...
    dw $0AFA, $008B ; Samus Y
    dw $D8B8, $2C00 ; Events, Items, Doors
    dw #$FFFF
.after
...
preset_prkd15_upper_norfair_rising_tide:
    ...
    dw $0AF6, $02AF ; Samus X
    dw $0AFA, $018B ; Samus Y
    dw $D8B8, $2E00 ; Events, Items, Doors
...
preset_prkd15_upper_norfair_bat_cave:
    ...
    dw $D91A, $002D ; Events, Items, Doors
    dw #$FFFF
.after
...
preset_prkd15_upper_norfair_single_chamber:
    ...
    dw $0917, $00C0 ; Layer 2 X scroll in room in pixels?
    dw $0919, $00BD ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $FE00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $09C2, $0129 ; Health
    dw $09C6, $000F ; Missiles
    dw $09CA, $000A ; Supers
    ...
    dw $D91A, $0031 ; Events, Items, Doors
    dw #$FFFF
.after
...
preset_prkd15_upper_norfair_double_chamber:
    ...
    dw $0917, $0000 ; Layer 2 X scroll in room in pixels?
    dw $0919, $00DB ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $0100 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $09C2, $011D ; Health
    dw $09CA, $0009 ; Supers
...
preset_prkd15_upper_norfair_double_chamber_revisited:
    ...
    dw $D91A, $0033 ; Events, Items, Doors
    dw #$FFFF
.after
...
preset_prkd15_upper_norfair_single_chamber_revisited:
    ...
    dw $0917, $00F0 ; Layer 2 X scroll in room in pixels?
    dw $0919, $011F ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $FC00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0AF6, $01DB ; Samus X
...
preset_prkd15_upper_norfair_kronic_boost:
    ...
    dw $0915, $0200 ; Screen Y position in pixels
    dw $0917, $0000 ; Layer 2 X scroll in room in pixels?
    dw $0919, $0200 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $FF00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $09C2, $010A ; Health
...
preset_prkd15_lower_norfair_kihunter_stairs_down:
    ...
    dw $0917, $01D4 ; Layer 2 X scroll in room in pixels?
    dw $0919, $0038 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0923, $FF00 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
...
preset_prkd15_lower_norfair_wasteland:
    ...
    dw $0917, $0180 ; Layer 2 X scroll in room in pixels?
    dw $0919, $0310 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0923, $0000 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $09C2, $0088 ; Health
    dw $09CE, $0002 ; Pbs
...
preset_prkd15_lower_norfair_metal_ninja_pirates:
    ...
    dw $0917, $00C0 ; Layer 2 X scroll in room in pixels?
    dw $0919, $0195 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $FB00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $00E0 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $09C2, $0063 ; Health
    dw $09CA, $0007 ; Supers
...
preset_prkd15_lower_norfair_plowerhouse:
    ...
    dw $0915, $0000 ; Screen Y position in pixels
    dw $0917, $0177 ; Layer 2 X scroll in room in pixels?
    dw $0919, $0000 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $FD00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $0000 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $09C2, $00E9 ; Health
...
preset_prkd15_lower_norfair_springball_maze:
    ...
    dw $0915, $0000 ; Screen Y position in pixels
    dw $0917, $0100 ; Layer 2 X scroll in room in pixels?
    dw $0919, $000D ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $0000 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $FD00 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0A1C, $0002 ; Samus position/state
    dw $0A1E, $0004 ; More position/state
...
preset_prkd15_lower_norfair_single_chamber_final:
    ...
    dw $D91A, $0039 ; Events, Items, Doors
    dw #$FFFF
.after
...
preset_prkd15_lower_norfair_bubble_mountain_final:
    ...
    dw $0917, $0000 ; Layer 2 X scroll in room in pixels?
    dw $0919, $0014 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $FA00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $0000 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $09C2, $0056 ; Health
...
preset_prkd15_lower_norfair_frog_speedway:
    ...
    dw $0913, $7C00 ; Screen subpixel Y position
    dw $0915, $0000 ; Screen Y position in pixels
    dw $0917, $0014 ; Layer 2 X scroll in room in pixels?
    dw $0919, $0000 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $FE00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
...
preset_prkd15_kraid_mini_kraid:
    ...
    dw $0919, $00FA ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $0000 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $FF00 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
...
preset_prkd15_kraid_kraid_2:
    ...
    dw $D8B8, $2E24 ; Events, Items, Doors
    dw #$FFFF
.after
...
preset_prkd15_kraid_kraid_kihunters_revisit:
    ...
    dw $0915, $0000 ; Screen Y position in pixels
    dw $0917, $00E1 ; Layer 2 X scroll in room in pixels?
    dw $0919, $0000 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $FA00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $0000 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $09C6, $000B ; Missiles
    ...
    dw $0AFA, $00AB ; Samus Y
    dw $D8B8, $2EEC ; Events, Items, Doors
    dw #$FFFF
.after
...
preset_prkd15_kraid_leaving_kraids_lair:
    ...
    dw $0915, $001B ; Screen Y position in pixels
    dw $0917, $0000 ; Layer 2 X scroll in room in pixels?
    dw $0919, $001B ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $FF00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    ...
    dw $0AF6, $0025 ; Samus X
    dw $0AFA, $008B ; Samus Y
    dw $D91A, $003D ; Events, Items, Doors
    dw #$FFFF
.after
...
preset_prkd15_maridia_fish_tank:
    ...
    dw $0917, $00B7 ; Layer 2 X scroll in room in pixels?
    dw $0919, $0471 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $FF00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $F800 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0A1C, $0001 ; Samus position/state
    dw $0A1E, $0008 ; More position/state
...
preset_prkd15_maridia_mt_everest:
    ...
    dw $0917, $00C6 ; Layer 2 X scroll in room in pixels?
...
preset_prkd15_maridia_aqueduct:
    ...
    dw $0915, $0300 ; Screen Y position in pixels
    dw $09D2, $0002 ; Currently selected item
    dw $0917, $0006 ; Layer 2 X scroll in room in pixels?
    dw $0919, $0240 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $0100 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $FE00 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0A1C, $0001 ; Samus position/state
...
preset_prkd15_maridia_botwoon:
    ...
    dw $0917, $023F ; Layer 2 X scroll in room in pixels?
    dw $0919, $0001 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $0000 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0A1C, $0001 ; Samus position/state
    dw $0A1E, $0008 ; More position/state
...
preset_prkd15_maridia_reverse_halfie_climb:
    ...
    dw $090F, $8000 ; Screen subpixel X position.
    dw $0913, $0000 ; Screen subpixel Y position
    dw $0921, $F900 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $FF00 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $09C2, $0066 ; Health
    dw $0A68, $0000 ; Flash suit
...
preset_prkd15_maridia_reverse_crab_shaft:
    ...
    dw $0919, $00FE ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $0000 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $00E0 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0AF6, $0069 ; Samus X
    dw $0AFA, $018B ; Samus Y
...
preset_prkd15_backtracking_red_brinstar_green_gate:
    ...
    dw $0913, $8800 ; Screen subpixel Y position
    dw $0915, $0000 ; Screen Y position in pixels
    dw $0917, $001A ; Layer 2 X scroll in room in pixels?
    dw $0919, $0000 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0923, $FE00 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $09C2, $008E ; Health
    dw $09C6, $000B ; Missiles
...
preset_prkd15_backtracking_parlor_return:
    ...
    dw $0915, $0400 ; Screen Y position in pixels
    dw $09C6, $000A ; Missiles
    dw $0917, $02F1 ; Layer 2 X scroll in room in pixels?
...
preset_prkd15_backtracking_green_pirate_shaft_revisit:
    ...
    dw $0917, $0000 ; Layer 2 X scroll in room in pixels?
    dw $0919, $017C ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $FA00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0A1C, $0002 ; Samus position/state
    dw $0A1E, $0004 ; More position/state
    dw $0AF6, $0062 ; Samus X
    dw $0AFA, $029B ; Samus Y
    dw $0B3F, $0000 ; Blue suit
    dw $D91A, $0048 ; Events, Items, Doors
    dw #$FFFF
.after
...
preset_prkd15_backtracking_g4_hallway:
    ...
    dw $0917, $0001 ; Layer 2 X scroll in room in pixels?
    dw $0919, $0480 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $FF00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $FC00 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $09CA, $0004 ; Supers
    dw $0A1C, $0001 ; Samus position/state
...
preset_prkd15_tourian_metroids_2:
    ...
    dw $0913, $A400 ; Screen subpixel Y position
    dw $0915, $0000 ; Screen Y position in pixels
    dw $0917, $00D2 ; Layer 2 X scroll in room in pixels?
    dw $0919, $0000 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $FA00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $0000 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $09C2, $006B ; Health
...
preset_prkd15_tourian_gadora_room:
    ...
    dw $0917, $0000 ; Layer 2 X scroll in room in pixels?
    dw $0919, $00D0 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $FF00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $09CA, $0009 ; Supers
    dw $0A1C, $0001 ; Samus position/state
    dw $0A1E, $0008 ; More position/state
...
preset_prkd15_tourian_rinka_shaft:
    ...
    dw $0AF6, $03DB ; Samus X
    dw $0AFA, $008B ; Samus Y
    dw $D8C4, $01AF ; Events, Items, Doors
    dw #$FFFF
.after
...
preset_prkd15_tourian_climb_spark:
    ...
    dw $0917, $00B4 ; Layer 2 X scroll in room in pixels?
    dw $0919, $00BC ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $0100 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $FD00 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $09C2, $0171 ; Health
