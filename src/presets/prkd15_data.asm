...
preset_prkd15_crateria_ceres_escape:
...
preset_prkd15_crateria_ceres_last_3_rooms:
    dw #preset_prkd15_crateria_ceres_escape ; Crateria: Ceres Escape
    dw $078D, $ABA0 ; DDB
    dw $079B, $E021 ; MDB
...
preset_prkd15_tourian_mother_brain_2:
...
preset_prkd15_tourian_mother_brain_3:
    dw #preset_prkd15_tourian_mother_brain_2 ; Tourian: Mother Brain 2
    dw $09A6, $1009 ; Beams
    dw $09C2, $018F ; Health
    dw $09C6, $0000 ; Missiles
    dw $09CE, $0000 ; Pbs
...
preset_prkd15_tourian_zebes_escape:
    dw #preset_prkd15_tourian_mother_brain_3 ; Tourian: Mother Brain 3
    dw $09A6, $1009 ; Beams
    dw $0AF6, $0025 ; Samus X
...
preset_prkd15_tourian_escape_room_3:
    dw #preset_prkd15_tourian_zebes_escape ; Tourian: Zebes Escape
    dw $078D, $AAEC ; DDB
    dw $079B, $DE7A ; MDB
    dw $07F3, $0024 ; Music Bank
    dw $07F5, $0007 ; Music Track
...
preset_prkd15_tourian_escape_room_4:
...
preset_prkd15_tourian_escape_climb:
    dw #preset_prkd15_tourian_escape_room_4 ; Tourian: Escape Room 4
    dw $078D, $AB1C ; DDB
    dw $079B, $DEDE ; MDB
    dw $090F, $0000 ; Screen subpixel X position
...
preset_prkd15_tourian_escape_parlor:
    dw #preset_prkd15_tourian_escape_climb ; Tourian: Escape Climb
    dw $078D, $AB34 ; DDB
    dw $079B, $96BA ; MDB
    dw $090F, $8FFF ; Screen subpixel X position
    dw $0911, $0100 ; Screen X position in pixels
