...
preset_kpdr22_crateria_parlor_downback:
    ...
    dw $0919, $025F ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $FB00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
...
preset_kpdr22_crateria_pit_room:
    ...
    dw $0919, $0600 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $FF00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $00E0 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
...
preset_kpdr22_crateria_morph:
    ...
    dw $0917, $03C0 ; Layer 2 X scroll in room in pixels?
    dw $0919, $0180 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $FB00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0A1C, $0000 ; Samus position/state
    dw $0A1E, $0000 ; More position/state
...
preset_kpdr22_crateria_construction_zone:
    ...
    dw $0917, $0540 ; Layer 2 X scroll in room in pixels?
...
preset_kpdr22_crateria_climb_up:
    ...
    dw $0921, $FD00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $0000 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0A1C, $0002 ; Samus position/state
    dw $0A1E, $0004 ; More position/state
...
preset_kpdr22_crateria_parlor_revisit:
    ...
    dw $0923, $F800 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
...
preset_kpdr22_crateria_flyway:
    ...
    dw $0919, $016C ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $FF00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
...
preset_kpdr22_crateria_terminator:
    ...
    dw $0917, $00C0 ; Layer 2 X scroll in room in pixels?
    dw $0921, $FC00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $FE00 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
...
preset_kpdr22_crateria_green_pirate_shaft:
    ...
    dw $0917, $0000 ; Layer 2 X scroll in room in pixels?
    dw $0919, $017D ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $FA00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $0000 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $09C2, $00C7 ; Health
...
preset_kpdr22_brinstar_early_supers:
    ...
    dw $0919, $0314 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $0000 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $00E0 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $09C6, $0000 ; Missiles
    dw $0A1C, $0001 ; Samus position/state
...
preset_kpdr22_brinstar_dachora_room:
    ...
    dw $0919, $0494 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $FF00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $FC00 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $09C2, $0081 ; Health
    dw $09CA, $0004 ; Supers
...
preset_kpdr22_brinstar_big_pink:
    ...
    dw $0915, $0000 ; Screen Y position in pixels
    dw $0917, $0480 ; Layer 2 X scroll in room in pixels?
    dw $0919, $0000 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $0100 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $0000 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
...
preset_kpdr22_brinstar_green_hill_zone:
    ...
    dw $0917, $0240 ; Layer 2 X scroll in room in pixels?
    dw $0919, $048C ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $FF00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $FE00 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $09A6, $1000 ; Beams
    dw $09A8, $1000 ; Beams
...
preset_kpdr22_brinstar_noob_bridge:
    ...
    dw $0917, $0540 ; Layer 2 X scroll in room in pixels?
    dw $0919, $0240 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $0100 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $0000 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $09C2, $0077 ; Health
...
preset_kpdr22_brinstar_red_tower:
    ...
    dw $0915, $0000 ; Screen Y position in pixels
    dw $0917, $0361 ; Layer 2 X scroll in room in pixels?
    dw $0919, $0000 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $09CA, $0004 ; Supers
...
preset_kpdr22_brinstar_skree_boost:
    ...
    dw $0917, $0000 ; Layer 2 X scroll in room in pixels?
    dw $0919, $06D3 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0923, $FC00 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
...
preset_kpdr22_brinstar_entering_kraids_lair:
    ...
    dw $0917, $0000 ; Layer 2 X scroll in room in pixels?
    dw $0919, $0100 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0923, $FF00 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
...
preset_kpdr22_brinstar_kraid_kihunters:
    dw #preset_kpdr22_brinstar_entering_kraids_lair ; Brinstar: Entering Kraids Lair
    dw $078D, $923A ; DDB
    dw $079B, $A471 ; MDB
    dw $090F, $8000 ; Screen subpixel X position.
    dw $0911, $0100 ; Screen X position in pixels
...
preset_kpdr22_brinstar_mini_kraid:
    dw #preset_kpdr22_brinstar_kraid_kihunters ; Brinstar: Kraid Kihunters
    dw $078D, $9156 ; DDB
    dw $079B, $A4DA ; MDB
...
preset_kpdr22_brinstar_kraid:
    dw #preset_kpdr22_brinstar_mini_kraid ; Brinstar: Mini Kraid
    dw $078D, $919E ; DDB
    dw $079B, $A56B ; MDB
    ...
    dw $0917, $0100 ; Layer 2 X scroll in room in pixels?
    dw $0921, $0100 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $09C2, $0043 ; Health
    dw $09C6, $0005 ; Missiles
...
preset_kpdr22_brinstar_leaving_varia:
    dw #preset_kpdr22_brinstar_kraid ; Brinstar: Kraid
    dw $078D, $91DA ; DDB
    dw $079B, $A6E2 ; MDB
    dw $07F5, $0003 ; Music Track
...
preset_kpdr22_brinstar_mini_kraid_revisit:
    dw #preset_kpdr22_brinstar_leaving_varia ; Brinstar: Leaving Varia
    dw $078D, $91CE ; DDB
    dw $079B, $A56B ; MDB
    dw $090F, $3000 ; Screen subpixel X position.
...
preset_kpdr22_brinstar_kraid_kihunters_revisit:
    dw #preset_kpdr22_brinstar_mini_kraid_revisit ; Brinstar: Mini Kraid Revisit
    dw $078D, $91AA ; DDB
    dw $079B, $A521 ; MDB
...
preset_kpdr22_brinstar_kraid_etank:
    dw #preset_kpdr22_brinstar_kraid_kihunters_revisit ; Brinstar: Kraid Kihunters Revisit
    dw $078D, $916E ; DDB
    dw $079B, $A471 ; MDB
    dw $07F3, $0012 ; Music Bank
    dw $07F5, $0005 ; Music Track
    ...
    dw $0919, $0100 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $FF00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $FFE0 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
...
preset_kpdr22_upper_norfair_business_center:
    dw #preset_kpdr22_brinstar_kraid_etank ; Brinstar: Kraid E-tank
    dw $078D, $9246 ; DDB
    dw $079B, $A7DE ; MDB
    ...
    dw $0919, $01AA ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $0000 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $00E0 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $09C6, $0006 ; Missiles
    dw $09CA, $0004 ; Supers
...
preset_kpdr22_upper_norfair_hi_jump_etank:
    dw #preset_kpdr22_upper_norfair_business_center ; Upper Norfair: Business Center
    dw $090F, $EFFF ; Screen subpixel X position.
    dw $0915, $051B ; Screen Y position in pixels
    dw $0919, $03D4 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $09CA, $0003 ; Supers
    dw $0A1C, $0002 ; Samus position/state
    dw $0A1E, $0004 ; More position/state
...
preset_kpdr22_upper_norfair_business_center_2:
...
preset_kpdr22_upper_norfair_precathedral:
    dw #preset_kpdr22_upper_norfair_business_center_2 ; Upper Norfair: Business Center 2
    dw $078D, $941A ; DDB
    dw $079B, $A7DE ; MDB
    dw $090F, $B000 ; Screen subpixel X position.
    dw $0911, $0000 ; Screen X position in pixels
    ...
    dw $0917, $0000 ; Layer 2 X scroll in room in pixels?
    dw $0919, $023A ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0923, $FB00 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0AF6, $00A5 ; Samus X
    dw $0AFA, $038B ; Samus Y
    dw #$FFFF
...
preset_kpdr22_upper_norfair_bubble_mountain:
    ...
    dw $0915, $0000 ; Screen Y position in pixels
    dw $09C2, $0179 ; Health
    dw $0917, $0300 ; Layer 2 X scroll in room in pixels?
    dw $0919, $0000 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $09C2, $0115 ; Health
...
preset_kpdr22_upper_norfair_single_chamber:
    ...
    dw $0919, $00C3 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $FE00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $0000 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
...
preset_kpdr22_upper_norfair_double_chamber:
    ...
    dw $0917, $0000 ; Layer 2 X scroll in room in pixels?
    dw $0919, $00D5 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $0100 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $09C6, $0008 ; Missiles
...
preset_kpdr22_upper_norfair_bubble_mountain_revisit:
    ...
    dw $0919, $0001 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $FF00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $FF00 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
...
preset_kpdr22_upper_norfair_business_center_3:
...
preset_kpdr22_red_brinstar_alpha_spark:
    dw #preset_kpdr22_upper_norfair_business_center_3 ; Upper Norfair: Business Center 3
    dw $078D, $92EE ; DDB
    dw $079B, $A6A1 ; MDB
    dw $07F3, $0012 ; Music Bank
    dw $07F5, $0003 ; Music Track
...
preset_kpdr22_red_brinstar_reverse_skree_boost:
    ...
    dw $0915, $0100 ; Screen Y position in pixels
    dw $0919, $00C0 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $FE00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $09CA, $0005 ; Supers
    dw $0A1C, $0002 ; Samus position/state
    dw $0A1E, $0004 ; More position/state
...
preset_kpdr22_red_brinstar_hellway:
    ...
    dw $0913, $6800 ; Screen subpixel Y position
    dw $0921, $FF00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $F700 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0A1C, $0001 ; Samus position/state
    dw $0A1E, $0008 ; More position/state
    dw $0AF6, $008F ; Samus X
    dw #$FFFF
...
preset_kpdr22_red_brinstar_caterpillars_down:
    ...
    dw $0913, $4400 ; Screen subpixel Y position
    dw $09C2, $017D ; Health
    dw $0917, $017C ; Layer 2 X scroll in room in pixels?
    dw $0921, $0100 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $0000 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $09C2, $0119 ; Health
...
preset_kpdr22_red_brinstar_alpha_power_bombs:
    ...
    dw $0917, $0000 ; Layer 2 X scroll in room in pixels?
    dw $0919, $071C ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0923, $FB00 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $09CA, $0004 ; Supers
    dw $0A1C, $0002 ; Samus position/state
    dw $0A1E, $0004 ; More position/state
...
preset_kpdr22_wrecked_ship_entering_wrecked_ship:
    ...
    dw $0915, $0400 ; Screen Y position in pixels
    dw $09C2, $00D8 ; Health
    dw $0917, $0380 ; Layer 2 X scroll in room in pixels?
    dw $0923, $FC00 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $09CA, $0004 ; Supers
...
preset_kpdr22_wrecked_ship_basement:
    ...
    dw $0917, $0300 ; Layer 2 X scroll in room in pixels?
    dw $0919, $0557 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $FD00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $FD00 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $09CA, $0003 ; Supers
...
preset_kpdr22_wrecked_ship_shaft_to_supers:
    ...
    dw $0913, $FC00 ; Screen subpixel Y position
    dw $0917, $019C ; Layer 2 X scroll in room in pixels?
...
preset_kpdr22_wrecked_ship_attic:
    ...
    dw $0917, $0300 ; Layer 2 X scroll in room in pixels?
    dw $0921, $FD00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $FA00 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
...
preset_kpdr22_wrecked_ship_upper_west_ocean:
    ...
    dw $09C2, $0152 ; Health
    dw $0917, $0000 ; Layer 2 X scroll in room in pixels?
    dw $0919, $001E ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $FC00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $FF00 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $09CA, $0009 ; Supers
    dw $0A1C, $0002 ; Samus position/state
...
preset_kpdr22_wrecked_ship_pancakes_and_wavers:
    ...
    dw $0917, $0100 ; Layer 2 X scroll in room in pixels?
    dw $0919, $0000 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $F800 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $0000 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0A1C, $0001 ; Samus position/state
    dw $0A1E, $0008 ; More position/state
...
preset_kpdr22_wrecked_ship_moat_ball:
    ...
    dw $0917, $0072 ; Layer 2 X scroll in room in pixels?
    dw $0921, $FA00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $FD00 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0A1C, $0002 ; Samus position/state
    dw $0A1E, $0004 ; More position/state
...
preset_kpdr22_wrecked_ship_crateria_kihunters_return:
    ...
    dw $0917, $0000 ; Layer 2 X scroll in room in pixels?
    dw $0919, $0005 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $FE00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $0000 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0AF6, $003B ; Samus X
...
preset_kpdr22_red_brinstar_final_red_tower_elevator:
    ...
    dw $0915, $0238 ; Screen Y position in pixels
    dw $09C2, $0121 ; Health
    dw $0919, $0238 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $0000 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $00E0 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
...
preset_kpdr22_red_brinstar_final_hellway_revisit:
    dw #preset_kpdr22_red_brinstar_final_red_tower_elevator ; Red Brinstar Final: Red Tower Elevator
    dw $090F, $C000 ; Screen subpixel X position.
    dw $0913, $2800 ; Screen subpixel Y position
    dw $0915, $0500 ; Screen Y position in pixels
    dw $0919, $0500 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0A1C, $0002 ; Samus position/state
    dw $0A1E, $0004 ; More position/state
    dw $0AF6, $0040 ; Samus X
    dw $0AFA, $058B ; Samus Y
...
preset_kpdr22_red_brinstar_final_red_tower_down:
    dw #preset_kpdr22_red_brinstar_final_hellway_revisit ; Red Brinstar Final: Hellway Revisit
    dw $078D, $90AE ; DDB
    dw $079B, $A2F7 ; MDB
...
preset_kpdr22_red_brinstar_final_skree_boost_final:
    dw #preset_kpdr22_red_brinstar_final_red_tower_down ; Red Brinstar Final: Red Tower Down
    dw $078D, $907E ; DDB
    dw $079B, $A253 ; MDB
...
preset_kpdr22_red_brinstar_final_below_spazer_final:
    dw #preset_kpdr22_red_brinstar_final_skree_boost_final ; Red Brinstar Final: Skree Boost Final
    dw $078D, $9042 ; DDB
    dw $079B, $A3DD ; MDB
...
preset_kpdr22_maridia_breaking_tube:
    dw #preset_kpdr22_red_brinstar_final_below_spazer_final ; Red Brinstar Final: Below Spazer Final
    dw $078D, $911A ; DDB
    dw $079B, $CF54 ; MDB
    dw $09D2, $0003 ; Currently selected item
    dw $090F, $E000 ; Screen subpixel X position.
...
preset_kpdr22_maridia_fish_tank:
    dw #preset_kpdr22_maridia_breaking_tube ; Maridia: Breaking Tube
    dw $078D, $A330 ; DDB
    dw $079B, $CFC9 ; MDB
    ...
    dw $0917, $00BE ; Layer 2 X scroll in room in pixels?
    dw $0919, $0477 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $FF00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $F800 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $09CE, $0002 ; Pbs
    dw $09D2, $0000 ; Currently selected item
...
preset_kpdr22_maridia_mt_everest:
    ...
    dw $0917, $00C0 ; Layer 2 X scroll in room in pixels?
    dw $0919, $0257 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0923, $FC00 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
...
preset_kpdr22_maridia_halfie_setup:
    ...
    dw $0917, $0000 ; Layer 2 X scroll in room in pixels?
    dw $0919, $001F ; Layer 2 Y scroll in room in pixels? (up = positive)
...
preset_kpdr22_maridia_womple_jump:
...
preset_kpdr22_maridia_cac_alley_east:
    dw #preset_kpdr22_maridia_womple_jump ; Maridia: Womple Jump
    dw $078D, $A7E0 ; DDB
    dw $079B, $D913 ; MDB
    dw $090F, $8000 ; Screen subpixel X position.
...
preset_kpdr22_maridia_cac_alley_west:
    ...
    dw $090F, $B000 ; Screen subpixel X position.
    dw $0915, $0002 ; Screen Y position in pixels
    dw $0919, $0002 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $FB00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $FF00 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $09C6, $000B ; Missiles
    dw $09CA, $0007 ; Supers
...
preset_kpdr22_maridia_plasma_climb:
    ...
    dw $0917, $01C0 ; Layer 2 X scroll in room in pixels?
    dw $0919, $00F3 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $FC00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $FB00 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0A1C, $0001 ; Samus position/state
    dw $0A1E, $0008 ; More position/state
...
preset_kpdr22_maridia_plasma_spark_revisit:
    ...
    dw $0919, $0253 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $FF00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $09A6, $1009 ; Beams
    dw $09A8, $1009 ; Beams
    dw $09C2, $0108 ; Health
...
preset_kpdr22_maridia_toilet:
    ...
    dw $0917, $0028 ; Layer 2 X scroll in room in pixels?
    dw $0919, $021F ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $FD00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $FF00 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $09C2, $00A9 ; Health
    dw $09CA, $0009 ; Supers
...
preset_kpdr22_upper_norfair_revisit_ice_beam_gates:
    ...
    dw $0919, $025C ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $0000 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $00E0 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $09CA, $0007 ; Supers
...
preset_kpdr22_upper_norfair_revisit_magdollite_tunnel_upper:
    ...
    dw $0919, $0177 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $0000 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $00E0 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
...
preset_kpdr22_lower_norfair_ln_main_hall:
    ...
    dw $09C2, $011E ; Health
    dw $0917, $0300 ; Layer 2 X scroll in room in pixels?
    dw $0919, $0301 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $FC00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $00E0 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $09CE, $0004 ; Pbs
    dw $09D2, $0003 ; Currently selected item
...
preset_kpdr22_lower_norfair_kihunter_stairs_down:
    ...
    dw $0917, $01E1 ; Layer 2 X scroll in room in pixels?
    dw $0919, $0032 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0923, $FF00 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
...
preset_kpdr22_lower_norfair_wasteland:
    ...
    dw $09C2, $0110 ; Health
    dw $0917, $0180 ; Layer 2 X scroll in room in pixels?
    dw $0919, $0312 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0923, $0000 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $09CE, $0002 ; Pbs
...
preset_kpdr22_lower_norfair_bubble_mountain_final:
    ...
    dw $09C2, $00D8 ; Health
    dw $0917, $0000 ; Layer 2 X scroll in room in pixels?
    dw $0919, $0010 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $FA00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $0000 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
...
preset_kpdr22_backtracking_fish_tank_revisit:
    ...
    dw $0917, $00BB ; Layer 2 X scroll in room in pixels?
    dw $0919, $0476 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $FF00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $F800 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0A1C, $0001 ; Samus position/state
    dw $0A1E, $0008 ; More position/state
...
preset_kpdr22_backtracking_mt_everest_revisit_revisit:
    ...
    dw $0915, $0000 ; Screen Y position in pixels
    dw $0917, $004E ; Layer 2 X scroll in room in pixels?
    dw $0919, $0000 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $0100 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $FE00 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0A1C, $0002 ; Samus position/state
...
preset_kpdr22_backtracking_red_brinstar_green_gate:
    dw #preset_kpdr22_backtracking_mt_everest_revisit_revisit ; Backtracking: Mt Everest Revisit Revisit
    dw $078D, $A42C ; DDB
    dw $079B, $D104 ; MDB
...
preset_kpdr22_backtracking_parlor_spacejump:
    ...
    dw $0913, $CC00 ; Screen subpixel Y position
    dw $0915, $0400 ; Screen Y position in pixels
    dw $0917, $02EE ; Layer 2 X scroll in room in pixels?
    dw $0921, $F700 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $FC00 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
...
preset_kpdr22_tourian_metroids_3:
    ...
    dw $09C2, $01C8 ; Health
    dw $0919, $00C6 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $FF00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $09CA, $0009 ; Supers
    dw $0A1C, $0001 ; Samus position/state
    dw $0A1E, $0008 ; More position/state
...
preset_kpdr22_tourian_gedora_room:
preset_kpdr22_tourian_gadora_room:
    ...
    dw $0917, $0000 ; Layer 2 X scroll in room in pixels?
    dw $0919, $00D1 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $FF00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $09CA, $0009 ; Supers
    dw $0A1C, $0001 ; Samus position/state
    dw $0A1E, $0008 ; More position/state
...
preset_kpdr22_tourian_zeb_skip:
    ...
    dw $0919, $0193 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $0100 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $09CA, $0007 ; Supers
    dw $0A1C, $0002 ; Samus position/state
    dw $0A1E, $0004 ; More position/state
...
preset_kpdr22_tourian_climb_spark:
    ...
    dw $09C2, $01D5 ; Health
    dw $0917, $00B8 ; Layer 2 X scroll in room in pixels?
    dw $0919, $00B3 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dw $0921, $0100 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dw $0923, $FD00 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
...
preset_kpdr22_tourian_escape_parlor:
    dw #preset_kpdr22_tourian_climb_spark ; Tourian: Climb Spark
    dw $078D, $AB34 ; DDB
    dw $079B, $96BA ; MDB
    dw $090F, $BFFF ; Screen subpixel X position.
    dw $0911, $0100 ; Screen X position in pixels
