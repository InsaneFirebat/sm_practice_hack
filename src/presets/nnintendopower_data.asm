...
preset_nintendopower_wrecked_ship_forgotten_highway_door:
...
preset_nintendopower_wrecked_ship_moat_missiles:
    dw #preset_nintendopower_wrecked_ship_forgotten_highway_door ; Wrecked Ship: Forgotten Highway Door
...
preset_nintendopower_maridia_jump_before_mama_turtle:
...
preset_nintendopower_maridia_mama_turtle:
    dw #preset_nintendopower_maridia_jump_before_mama_turtle ; Maridia: Jump before Mama Turtle
...
preset_nintendopower_norfair_2_hard_room_before_ridley:
...
preset_nintendopower_norfair_2_ridley:
    dw #preset_nintendopower_norfair_2_hard_room_before_ridley ; Norfair 2: Hard Room before Ridley
...
preset_nintendopower_tourian_escape_parlor:
    ...
    dl $7E0915 : db $02 : dw $0420 ; Screen Y position in pixels
    dl $7E09C2 : db $02 : dw $01EB ; Health
    dl $7E0A1C : db $02 : dw $001B ; Samus position/state
