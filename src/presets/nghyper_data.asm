...
preset_nghyper_ceres_station_magnet_stairs:
    ...
    dl $7E090F : db $02 : dw $AB00 ; Screen subpixel X position.
...
preset_nghyper_ceres_station_magnet_stairs_escape:
    ...
    dl $7E090F : db $02 : dw $DE00 ; Screen subpixel X position.
    dl $7E0911 : db $02 : dw $0000 ; Screen X position in pixels
...
preset_nghyper_wrecked_ship_ship:
    ...
    dl $7ED7FA : db $02 : dw $0004 ; SRAM copy
...
preset_nghyper_wrecked_ship_entering_wrecked_ship:
    ...
    dl $7E0913 : db $02 : dw $0000 ; Screen subpixel Y position
    dl $7E0915 : db $02 : dw $040F ; Screen Y position in pixels
    dl $7E09CA : db $02 : dw $0030 ; Supers
    dl $7E0AF6 : db $02 : dw $0799 ; Samus X
...
preset_nghyper_wrecked_ship_wrecked_ship_shaft:
    ...
    dl $7E07F5 : db $02 : dw $0006 ; Music Track
    dl $7E090F : db $02 : dw $0000 ; Screen subpixel X position.
    dl $7E0911 : db $02 : dw $021C ; Screen X position in pixels
...
preset_nghyper_red_tower_breaking_maridia_tube:
    ...
    dl $7E09CA : db $02 : dw $002F ; Supers
...
preset_nghyper_norfair_preridley_ln_main_hall:
    ...
    dl $7E09C2 : db $02 : dw $05CE ; Health
    dl $7E0A1C : db $02 : dw $009B ; Samus position/state
    dl $7E0A1E : db $02 : dw $0000 ; More position/state
...
preset_nghyper_norfair_preridley_fast_pillars_setup:
    ...
    dl $7E0A1C : db $02 : dw $0001 ; Samus position/state
    dl $7E0A1E : db $02 : dw $0008 ; More position/state
    dl $7E0AF6 : db $02 : dw $07AE ; Samus X
...
preset_nghyper_norfair_preridley_kihunter_stairs:
    ...
    dl $7E0911 : db $02 : dw $0242 ; Screen X position in pixels
...
preset_nghyper_norfair_preridley_plowerhouse:
    ...
    dl $7E0911 : db $02 : dw $018B ; Screen X position in pixels
    dl $7E0913 : db $02 : dw $D400 ; Screen subpixel Y position
    dl $7E0915 : db $02 : dw $0000 ; Screen Y position in pixels
    dl $7E09C2 : db $02 : dw $05DB ; Health
    dl $7E09CA : db $02 : dw $0032 ; Supers
    dl $7E0AF6 : db $02 : dw $01F3 ; Samus X
...
preset_nghyper_norfair_postridley_kihunter_stairs_revisit:
    ...
    dl $7E079B : db $02 : dw $B5D5 ; MDB
    dl $7E090F : db $02 : dw $8900 ; Screen subpixel X position.
    ...
    dl $7E0A1C : db $02 : dw $0002 ; Samus position/state
    dl $7E0A1E : db $02 : dw $0004 ; More position/state
    dl $7E0AF6 : db $02 : dw $058C ; Samus X
...
preset_nghyper_norfair_postridley_fireflea_room:
    ...
    dl $7E079B : db $02 : dw $B585 ; MDB
    dl $7E090F : db $02 : dw $CF00 ; Screen subpixel X position.
    dl $7E0911 : db $02 : dw $0000 ; Screen X position in pixels
...
preset_nghyper_kraids_lair_leaving_kraid:
    ...
    dl $7E09C2 : db $02 : dw $04E9 ; Health
    dl $7E09CA : db $02 : dw $0030 ; Supers
    dl $7E0A1C : db $02 : dw $0002 ; Samus position/state
    dl $7E0A1E : db $02 : dw $0004 ; More position/state
...
preset_nghyper_kraids_lair_kraid_hallway_revisit:
    ...
    dl $7E09C2 : db $02 : dw $04E5 ; Health
...
preset_nghyper_kraids_lair_warehouse_zealas:
    ...
    dl $7E0915 : db $02 : dw $0000 ; Screen Y position in pixels
    dl $7E09C2 : db $02 : dw $04EA ; Health
    dl $7E09CA : db $02 : dw $0032 ; Supers
    dl $7E0AF6 : db $02 : dw $016E ; Samus X
    dl $7E0AFA : db $02 : dw $00AB ; Samus Y
...
preset_nghyper_maridia_aqueduct:
    ...
    dl $7E09C2 : db $02 : dw $04AE ; Health
    dl $7E09CA : db $02 : dw $0030 ; Supers
    dl $7E0A1C : db $02 : dw $0079 ; Samus position/state
    dl $7E0A1E : db $02 : dw $1108 ; More position/state
...
preset_nghyper_maridia_halfie:
    ...
    dl $7E09C2 : db $02 : dw $0599 ; Health
    dl $7E09CE : db $02 : dw $0025 ; Pbs
...
preset_nghyper_maridia_draygon:
    ...
    dl $7E0913 : db $02 : dw $4000 ; Screen subpixel Y position
    dl $7E0915 : db $02 : dw $0200 ; Screen Y position in pixels
    dl $7E09C2 : db $02 : dw $052E ; Health
    dl $7E09CA : db $02 : dw $002E ; Supers
    dl $7E0A1C : db $02 : dw $0002 ; Samus position/state
    dl $7E0A1E : db $02 : dw $0004 ; More position/state
    dl $7E0AF6 : db $02 : dw $0069 ; Samus X
...
preset_nghyper_maridia_womple_jump:
    ...
    dl $7E0913 : db $02 : dw $3000 ; Screen subpixel Y position
    dl $7E0915 : db $02 : dw $0000 ; Screen Y position in pixels
    dl $7E09C2 : db $02 : dw $0525 ; Health
    dl $7E09C6 : db $02 : dw $00DD ; Missiles
...
preset_nghyper_maridia_reverse_botwoon_hallway:
    ...
    dl $7E0915 : db $02 : dw $0200 ; Screen Y position in pixels
    dl $7E09C2 : db $02 : dw $04B5 ; Health
    dl $7E09C6 : db $02 : dw $00DB ; Missiles
    dl $7E0A68 : db $02 : dw $0000 ; Flash suit
...
preset_nghyper_crateria_crateria_kihunters_final:
    ...
    dl $7E0911 : db $02 : dw $0000 ; Screen X position in pixels
    dl $7E0913 : db $02 : dw $2C00 ; Screen subpixel Y position
    dl $7E09CA : db $02 : dw $002D ; Supers
    dl $7E0A1C : db $02 : dw $0001 ; Samus position/state
    dl $7E0A1E : db $02 : dw $0008 ; More position/state
...
preset_nghyper_crateria_landing_site:
    ...
    dl $7E0A1C : db $02 : dw $0002 ; Samus position/state
    dl $7E0A1E : db $02 : dw $0004 ; More position/state
    dl $7E0AF6 : db $02 : dw $0159 ; Samus X
    dl $7E0AFA : db $02 : dw $00BB ; Samus Y
    dw #$FFFF
.after
...
preset_nghyper_tourian_metroids_1:
    ...
    dl $7E0915 : db $02 : dw $0300 ; Screen Y position in pixels
    dl $7E09C2 : db $02 : dw $04BA ; Health
...
preset_nghyper_tourian_metroids_2:
    ...
    dl $7E0913 : db $02 : dw $07FF ; Screen subpixel Y position
    dl $7E0915 : db $02 : dw $0000 ; Screen Y position in pixels
    dl $7E09C2 : db $02 : dw $03EE ; Health
    dl $7E09C6 : db $02 : dw $00E1 ; Missiles
    dl $7E09CA : db $02 : dw $002F ; Supers
...
preset_nghyper_tourian_metroids_3:
    ...
    dl $7E09C2 : db $02 : dw $03B4 ; Health
    dl $7E09C6 : db $02 : dw $00E3 ; Missiles
    dl $7E09CA : db $02 : dw $0030 ; Supers
...
preset_nghyper_tourian_metroids_4:
    ...
    dl $7E0915 : db $02 : dw $0000 ; Screen Y position in pixels
    dl $7E09C2 : db $02 : dw $0389 ; Health
    dl $7E09C6 : db $02 : dw $00E6 ; Missiles
    dl $7E09CA : db $02 : dw $0031 ; Supers
...
preset_nghyper_tourian_baby_skip:
    ...
    dl $7E0911 : db $02 : dw $0100 ; Screen X position in pixels
    dl $7E09C2 : db $02 : dw $032E ; Health
...
preset_nghyper_tourian_escape_room_3:
    ...
    dl $7E0AFA : db $02 : dw $018B ; Samus Y
    dl $7ED820 : db $02 : dw $4FE5 ; Events, Items, Doors
...
preset_nghyper_tourian_escape_room_4:
    ...
    dl $7E0AF6 : db $02 : dw $05D5 ; Samus X
    dl $7E0AFA : db $02 : dw $008B ; Samus Y
    dw #$FFFF
.after
...
preset_nghyper_tourian_escape_parlor:
    ...
    dl $7E0915 : db $02 : dw $0000 ; Screen Y position in pixels
    dl $7E09C2 : db $02 : dw $052A ; Health
    dl $7E0A1C : db $02 : dw $0002 ; Samus position/state
    dl $7E0A1E : db $02 : dw $0004 ; More position/state
    dl $7E0AF6 : db $02 : dw $01CF ; Samus X
