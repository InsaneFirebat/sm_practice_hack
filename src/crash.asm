...
CrashDump:
{
    ...
    LDA #$2C01 : STA !ram_tilemap_buffer+$30C ; B
    LDA #$2C11 : STA !ram_tilemap_buffer+$30E ; R
    LDA #$2C0A : STA !ram_tilemap_buffer+$310 ; K
    LDA #$2C44 : STA !ram_tilemap_buffer+$314 ; #
    LDA #$2C4E : STA !ram_tilemap_buffer+$316 ; $
    STA !ram_tilemap_buffer+$326 ; $

  .drawStack_bridge
    BRA .drawStack

  .COPcrash
    LDA #$2C02 : STA !ram_tilemap_buffer+$30C ; C
    LDA #$2C7D : STA !ram_tilemap_buffer+$30E ; O
    LDA #$2C0F : STA !ram_tilemap_buffer+$310 ; P
    LDA #$2C44 : STA !ram_tilemap_buffer+$314 ; #
    LDA #$2C4E : STA !ram_tilemap_buffer+$316 ; $
    STA !ram_tilemap_buffer+$326 ; $
