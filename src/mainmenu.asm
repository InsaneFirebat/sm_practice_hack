...
if !FEATURE_CUSTOMIZE_MENU
    ...
    dw #$0000
    %cm_version_header("OXIDE PRACTICE HACK", !VERSION_MAJOR, !VERSION_MINOR, !VERSION_BUILD, !VERSION_REV_1, !VERSION_REV_2)
...
TeleportCrateriaMenu:
    ...
    dw #tel_crateria0C
    dw #$0000
    %cm_header("BLUE SURFACE SAVE STATIONS")

tel_crateriaship:
    %cm_jsl("Crateria Ship", #action_teleport, #$0000)

tel_crateriaparlor:
    %cm_jsl("DEBUG Elevator", #action_teleport, #$0008)

tel_crateria0B:
    %cm_jsl("DEBUG Toxic Tank Long Spark", #action_teleport, #$000B)

tel_crateria0C:
    %cm_jsl("DEBUG Toxic Tank Kraid", #action_teleport, #$000C)
...
TeleportBrinstarMenu:
    ...
    dw #tel_brinstar11
    dw #$0000
    %cm_header("TOXIC TANK SAVE STATIONS")

tel_brinstarpink:
    %cm_jsl("Toxic Tank Crab Save", #action_teleport, #$0100)

tel_brinstar04:
    %cm_jsl("Toxic Tank Supers Save", #action_teleport, #$0104)

tel_brinstar0B:
    %cm_jsl("DEBUG Elevator to Bubbles", #action_teleport, #$000B)

tel_brinstar11:
    %cm_jsl("DEBUG Kraid", #action_teleport, #$0111)
...
TeleportNorfairMenu:
    ...
    dw #tel_norfair16
    dw #$0000
    %cm_header("EASY NORFAIR SAVE STATIONS")

tel_norfairgrapple:
    %cm_jsl("Norfair Save", #action_teleport, #$0200)

tel_norfairbubble:
    %cm_jsl("DEBUG Norfair 01", #action_teleport, #$0201)

tel_norfairtunnel:
    %cm_jsl("Norfair Bubble Refill", #action_teleport, #$0202)

tel_norfaircrocomire:
    %cm_jsl("Norfair Bubbles Save", #action_teleport, #$0203)

tel_norfairlnelevator:
    %cm_jsl("Norfair Save 05", #action_teleport, #$0205)

tel_norfairridley:
    %cm_jsl("DEBUG Elevator to Surface", #action_teleport, #$0208)

tel_norfair09:
    %cm_jsl("DEBUG Norfair 09", #action_teleport, #$0209)

tel_norfair13:
    %cm_jsl("DEBUG Norfair Gate 13", #action_teleport, #$0213)

tel_norfair16:
    %cm_jsl("DEBUG LN Elevator 16", #action_teleport, #$0216)
...
tel_wreckedship:
    %cm_jsl("Murder Ship Save", #action_teleport, #$0300)

tel_wreckedship10:
    %cm_jsl("DEBUG Murder Ship Shaktool", #action_teleport, #$0310)

tel_wreckedship11:
    %cm_jsl("DEBUG Too Many Enemies", #action_teleport, #$0311)
...
tel_maridiaelevator:
    %cm_jsl("DEBUG Maridia Bomb Torizo", #action_teleport, #$0401)

tel_maridiaaqueduct:
    %cm_jsl("Maridia Snail Save", #action_teleport, #$0402)

tel_maridiadraygon:
    %cm_jsl("Maridia Save 03", #action_teleport, #$0403)

tel_maridia08:
    %cm_jsl("DEBUG Maridia Elev Surface", #action_teleport, #$0408)

tel_maridia11:
    %cm_jsl("DEBUG Draygon", #action_teleport, #$0411)

tel_maridia12:
    %cm_jsl("DEBUG Maridia Refills", #action_teleport, #$0412)
...
tel_tourian11:
    %cm_jsl("Tourian Baby Metroid", #action_teleport, #$0511)
