...
MainMenu:
    ...
    dw #$0000
    %cm_version_header("KAIZO POSSIBLE", !VERSION_MAJOR, !VERSION_MINOR, !VERSION_BUILD, !VERSION_REV_1, !VERSION_REV_2)
...
ih_freeze_on_load:
    %cm_toggle("Freeze on Load State", !sram_freeze_on_load, #$0001, #0)

ih_loadstate_on_death:
