...
if !FEATURE_REDESIGN
    ...
    %cm_version_header("AXEIL INFOHUD")
endif
...
eq_currentreserves:
    %cm_numfield_word("Current Reserves", !SAMUS_RESERVE_ENERGY, 0, 400, 1, 20, #0)
...
eq_setmissiles:
    %cm_numfield_word("Missiles", !SAMUS_MISSILES_MAX, 0, 300, 5, 20, .routine)
  .routine
    LDA !SAMUS_MISSILES_MAX : STA !SAMUS_MISSILES
    RTL
...
eq_setsupers:
    %cm_numfield("Super Missiles", !SAMUS_SUPERS_MAX, 0, 30, 2, 2, .routine)
  .routine
    LDA !SAMUS_SUPERS_MAX : STA !SAMUS_SUPERS
    RTL
...
eq_setpbs:
    %cm_numfield("Power Bombs", !SAMUS_PBS_MAX, 0, 30, 1, 2, .routine)
  .routine
    LDA !SAMUS_PBS_MAX : STA !SAMUS_PBS
    RTL
...
ti_springball:
    %cm_equipment_item("Beam Combo", !ram_cm_spring, #$0002, #$FFFD)
...
ihmode_gateglitch:
    %cm_jsl("Gate Glitch", #action_select_infohud_mode, #$0014)
...
ihstrat_doorskip: ; changed to MB HP
    %cm_jsl("Parlor-Climb Doorskip", #action_select_room_strat, #$0000)
