...
eq_currentenergy:
    %cm_numfield_word("Current Energy", !SAMUS_HP, 0, 1299, #0)
...
eq_currentmissiles:
    %cm_numfield("Current Missiles", !SAMUS_MISSILES, 0, 60, 1, 2, #0)

eq_setmissiles:
    %cm_numfield("Missiles", !SAMUS_MISSILES_MAX, 0, 60, 2, 4, .routine)
    .routine
