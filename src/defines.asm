...
!FEATURE_MORPHLOCK ?= 0 ; Redesign has the code, but not the build flag
!FEATURE_DEV ?= 1
!RAW_TILE_GRAPHICS ?= 0
...
!ORG_INFOHUD = $FB8000 ; $3335
!ORG_INFOHUD_BANK80 = $80D047 ; $265, bank $80
...
!ORG_PRESETS_BANK82 = $82F8C8 ; $2C1, bank $82
!ORG_PRESETS_TINYSTATES_BANK82 = $82FC00 ; $9D, bank $82
!ORG_PRESETS_BANK80 = $80D800 ; $439, bank $80
!ORG_PRESETS_DATA = $FE8000 ; $20C0
!ORG_PRESETS_MENU = $FEE000 ; $108F
!ORG_PRESETS_CUSTOM = $85B000 ; $7EF
!ORG_MORPHLOCK = $80CDA0 ; $5C
...
!ORG_MISC_BANK8F = $8FFFC0 ; 26 bank $8F
!ORG_MINIMAP_BANKFD = $FDD500 ; $2000
!ORG_MINIMAP_BANK81 = $81F200 ; $64
!ORG_MINIMAP_BANK82 = $82FE00 ; $8C, bank $82
!ORG_MINIMAP_BANK90 = $90F8C5 ; $C8, bank $90
!ORG_SAVE = $80E000 ; $4C3
!ORG_RNG_BANK83 = $83C540 ; $1B3
...
!ORG_FANFARE_BANK84 = $84F60B ; $11
!ORG_FANFARE_BANK85 = $85FF00 ; $69
!ORG_CRASH = $80F000 ; $151, bank $80
!ORG_SPRITEPRIO = $81F800 ; $90
!ORG_SPRITEFEAT = $FBE000 ; $1060
...
!ram_spring_pants_enabled            = !WRAM_PERSIST_START+$30
...
!ram_cm_morphlock = !WRAM_MENU_START+$66
!ram_cm_menu_active = !WRAM_MENU_START+$68
...
!IH_CONTROLLER_ML = $8B
!IH_CONTROLLER_ML_NEW = $8F
!IH_CONTROLLER_ML_PREV = $97
endif
...
;!IH_CONTROLLER_PRI = !IH_CONTROLLER_ML
;!IH_CONTROLLER_PRI_NEW = !IH_CONTROLLER_ML_NEW
;!IH_CONTROLLER_PRI_PREV = !IH_CONTROLLER_ML_PREV
