...
!ORG_INFOHUD = $C08000 ;$83BB00 ; $2BD4
!ORG_MAINMENU = $87AE00 ; $28D6
!ORG_MENU_BANK89 = $83BB00 ; $20D6
!ORG_PRESETS_DATA = $C28000 ;$85B360 ; $2088
!ORG_MINIMAP_BANKFD = $DFD512 ; $2000   This overwrites Junkoids room names, which appear to be unused
!ORG_MAINMENU_INFOHUD = $85D140 ; $1439
!ORG_PRESETS_MENU = $C2DA00 ;$85AE60 ; $108F  NERFED for space in Junkoid
!ORG_SPRITEFEAT = $C38000 ;$83EF00 ; $ED4
!ORG_MENU_GFX = $B6F200 ; unused, $900, can be used to reduce menu code size
!ORG_MAINMENU_GAME = $87F000 ; $85C
!ORG_PRESETS_CUSTOM = $83B400 ; $6DB
!ORG_SAVE = $81F0B0 ; $439
!ORG_PRESETS_BANK80 = $80D1C0 ; $3B3, bank $80
!ORG_PRESETS_BANK82 = $82FC80 ; $2B0, bank $82
!ORG_INFOHUD_BANK80 = $80C950 ; $216, bank $80
!ORG_CRASH = $80D800 ;$80D600 ; $1BC, bank $80
!ORG_INIT = $81FC00 ; $124
...
!ORG_MINIMAP_BANK82 = $82FBC0 ; $8C, bank $82
...
!ram_cm_crown = !WRAM_MENU_START+$9C
