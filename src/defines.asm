...
!ORG_INFOHUD = $F5C8C0 ; $2BD4
!ORG_INFOHUD_BANK80 = $80FD00 ; $216, bank $80
!ORG_MAINMENU_INFOHUD = $85D380 ; $1439
!ORG_MAINMENU_GAME = $B3F6C0 ; $85C
!ORG_INIT = $81FAC0 ; $124
!ORG_MENU_BANK85 = $85FD00 ; $2C, bank $85
!ORG_MENU_BANK89 = $89BB00 ; $20D6
;!ORG_MENU_GFX = $F0D700 ; unused, $900, can be used to reduce menu code size
!ORG_MAINMENU = $87CA00 ; $28D6
!ORG_GAMEMODE = $85F800 ; $2ED
!ORG_PRESETS_BANK82 = $82FD58 ; $2B0, bank $82, reduced size slightly
!ORG_PRESETS_BANK80 = $80F000 ; $3B3, bank $80
;!ORG_PRESETS_DATA = $FE8000 ; $2088
;!ORG_PRESETS_MENU = $FEE000 ; $108F
!ORG_PRESETS_CUSTOM = $83C440 ; $6DB
!ORG_MORPHLOCK = $80CEC0 ; ???
!ORG_MISC_BANKA0 = $A0FE00 ; $2A, bank $A0
...
!ORG_MISC_BANK8B = $8BFFC0
!ORG_MISC_BANK8F = $8FFE00 ; $??, bank $8F
!ORG_MINIMAP_BANKFD = $DFD500 ; $2000, plus a couple routines
!ORG_MINIMAP_BANK82 = $82F848 ; $8C, bank $82
!ORG_MINIMAP_BANK90 = $90F640 ; $C8, bank $90
!ORG_MINIMAP_BANK90_PART1 = $90F699 ; $??, bank $90
!ORG_MINIMAP_BANK90_PART2 = $90F76F ; $??, bank $90
!ORG_SAVE = $80F600 ; $439
!ORG_RNG_BANK83 = $83E000 ; $148
...
!ORG_SPRITEFEAT = $F4B500 ; $ED4
!ORG_ROOMNAMES = $ED0000 ; whole bank pointer style
