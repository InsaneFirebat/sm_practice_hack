...
!ORG_INFOHUD = $83D100 ; $2BD4
!ORG_INFOHUD_BANK80 = $80C855 ; $216, bank $80
!ORG_MAINMENU_INFOHUD = $89B540 ; $92A
!ORG_MAINMENU_GAME = $87BE00 ; $85C
!ORG_MAINMENU_EQUIPMENT = $99EE40 ; $D6F
!ORG_MAINMENU_RNG = $B6F200 ; $8B1
!ORG_MAINMENU_CTRL = $92EE00 ; $
!ORG_INIT = $81FC80 ; $124
!ORG_MENU_BANK85 = $85FD00 ; $2C, bank $85
!ORG_MENU_BANK89 = $A19700 ; $20D6 - $900
!ORG_MENU_GFX = $87F000 ; $900
!ORG_MAINMENU = $AB8200 ; $137C
!ORG_GAMEMODE = $85F800 ; $2ED
!ORG_PRESETS_BANK82 = $82F90E ; $2B0, bank $82
!ORG_PRESETS_BANK80 = $80D916 ; $3B3, bank $80
;!ORG_PRESETS_DATA = $FE8000 ; $2088
;!ORG_PRESETS_MENU = $FEE000 ; $108F
!ORG_PRESETS_CUSTOM = $9DF900 ; $6DB
;!ORG_MORPHLOCK = $80CD90 ; ???
!ORG_MISC_BANK8B = $8BF780 ; 
!ORG_MISC_BANKA0 = $A0FEC0 ; $2A, bank $A0
;!ORG_MISC_BANK90 = $909E60 ; $1C, bank $90, overwrites vanilla unused
!ORG_MISC_BANK87 = $87FF00 ; $83
;!ORG_MISC_TILE_GRAPHICS = $8BFA00 ; unused, $140
;!ORG_MISC_BANK8B = $8BFA00 ; unused, $140
!ORG_MINIMAP_BANKFD = $E2B000 ; $2000
!ORG_MINIMAP_BANK82 = $82FC00 ; $8C, bank $82
!ORG_MINIMAP_BANK88 = $88FF00 ; $??
!ORG_MINIMAP_BANK90 = $90FF40 ; $C8, bank $90 (reduced size for Subversion)
!ORG_SAVE = $80F040 ; $439
!ORG_RNG_BANK83 = $86FD80 ; $148
...
!ORG_CRASH_BANK80 = $80F500 ; $1BC, bank $80
...
!ram_cm_metroid = !WRAM_MENU_START+$9C
!ram_cm_gravboots = !WRAM_MENU_START+$9E
!ram_cm_darkvisor = !WRAM_MENU_START+$A0
!ram_cm_hyper = !WRAM_MENU_START+$A2
...
!SAMUS_AMMO_MAX = $09C8
;!SAMUS_SUPERS = $09CA
!SAMUS_SPACEJUMP_MAX = $09CA
!SAMUS_SUPERS_MAX = $09CC
;!SAMUS_PBS = $09CE
!SAMUS_MISSILES_MAX = $09CE
!SAMUS_PBS_MAX = $09D0
