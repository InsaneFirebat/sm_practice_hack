...
echo Building Hyper Metroid Practice Hack
cd resources
...
python create_ips.py ..\build\00.sfc ..\build\ff.sfc ..\build\Hyper_InfoHUD_2.2.7.ips
...
python create_ips.py ..\build\00.sfc ..\build\ff.sfc ..\build\Hyper_InfoHUD_Savestates_2.2.7.ips
