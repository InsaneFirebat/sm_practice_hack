...
echo Building Blue Plague Practice Hack
cd resources
...
python create_ips.py ..\build\00.sfc ..\build\ff.sfc ..\build\BluePlague_InfoHUD_2.3.0.ips
...
python create_ips.py ..\build\00.sfc ..\build\ff.sfc ..\build\BluePlague_InfoHUD_Savestates_2.3.0.ips
