...
python create_ips.py ..\build\00.sfc ..\build\ff.sfc ..\build\ContainmentChamber_InfoHUD_2.2.8.ips
...
python create_ips.py ..\build\00.sfc ..\build\ff.sfc ..\build\ContainmentChamber_InfoHUD_Savestates_2.2.8.ips
