...
python create_ips.py ..\build\00.sfc ..\build\ff.sfc ..\build\Subpar_InfoHUD_2.5.X.ips

echo Building tinystate version
copy 00.sfc ..\build
copy ff.sfc ..\build
...
python create_ips.py ..\build\00.sfc ..\build\ff.sfc ..\build\Subpar_InfoHUD_Tinystates_2.5.X.ips
...
python create_ips.py ..\build\00.sfc ..\build\ff.sfc ..\build\Subpar_InfoHUD_Savestates_2.5.X.ips
