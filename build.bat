...
echo Building New Wet Dream Practice Hack
cd resources
...
python create_ips.py ..\build\00.sfc ..\build\ff.sfc ..\build\NewWetDream_InfoHUD_2.4.X.ips
...
python create_ips.py ..\build\00.sfc ..\build\ff.sfc ..\build\NewWetDream_InfoHUD_Savestates_2.4.X.ips
