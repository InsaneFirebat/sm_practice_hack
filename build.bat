...
python create_ips.py ..\build\00.sfc ..\build\ff.sfc ..\build\Decision_InfoHUD_2.4.X.ips
...
python create_ips.py ..\build\00.sfc ..\build\ff.sfc ..\build\Decision_InfoHUD_Savestates_2.4.X.ips
