...
python create_ips.py ..\build\00.sfc ..\build\ff.sfc ..\build\SZM_InfoHUD_2.3.0.ips
...
python create_ips.py ..\build\00.sfc ..\build\ff.sfc ..\build\SZM_InfoHUD_Savestates_2.3.0.ips
