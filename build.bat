...
python create_ips.py ..\build\00.sfc ..\build\ff.sfc ..\build\Hyper_InfoHUD_2.3.1.ips
...
python create_ips.py ..\build\00.sfc ..\build\ff.sfc ..\build\Hyper_InfoHUD_Savestates_2.3.1.ips
