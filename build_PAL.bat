...
python create_ips.py ..\build\00.sfc ..\build\ff.sfc ..\build\Custom_PAL_InfoHUD_2.5.X.ips
...
python create_ips.py ..\build\00.sfc ..\build\ff.sfc ..\build\Custom_PAL_InfoHUD_Savestates_2.5.X.ips
...
python create_ips.py ..\build\00.sfc ..\build\ff.sfc ..\build\Custom_PAL_InfoHUD_TinyStates_2.5.X.ips
