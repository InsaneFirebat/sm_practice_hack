...
python dos_to_unix.py ..\build\VITALITY_Symbols.sym
python sort_debug_symbols.py ..\build\VITALITY_Symbols.sym ..\build\VITALITY_Sorted.sym ..\build\VITALITY_Combined.sym
python create_ips.py ..\build\00.sfc ..\build\ff.sfc ..\build\VITALITY_sd2snes.ips
